...
//        System.out.print("Val 1 : " + url.toExternalForm());
//        System.out.print("Val 2 : " + String.valueOf(url.getPort()));
        
//        String urlPort = "";
//        
//        try {
//			urlPort = url.toExternalForm().split(String.valueOf(url.getPort()), -2)[1];
...
//		}
        ...
        if (url.getPort() == -1) {
        	...
        	urlPath = url.toExternalForm().split(String.valueOf(url.getPort()), -2)[1];
        }
    ...
    private void afterWrite() throws IOException {
        ...
        if ((!replyStr.startsWith("HTTP/1.0 200")) && !replyStr.startsWith("HTTP/1.1 200") && !replyStr.startsWith("HTTP/1.1 201")) {
